def englishNumber number
  ...
  left  = number
  write = left/10_0000_0000          #  百の桁以上の桁をwriteに入れます。
  left  = left - write*10_0000_0000  #  下2桁をleftに残します。
  ...
  write = left/1000000          #  百の桁以上の桁をwriteに入れます。
  left  = left - write*1000000  #  下2桁をleftに残します。
...
def sing(beer)
  while beer > 0
    ...
    puts englishNumber(beer) + " Bottles of beer"
